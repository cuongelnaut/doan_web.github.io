<?php
	...
	if(isset($_POST['dangnhap_home'])) {
		...
		if($taikhoan=='' || $matkhau ==''){
			echo '<script>alert("Dữ liệu còn trống")</script>';
		}else{
			$sql_select_admin = mysqli_query($con,"SELECT * FROM khachhang WHERE Email='$taikhoan' AND pass='$matkhau' LIMIT 1");
		...
		$name = $_POST['Ten'];
	 	...
	 	$giaohang = $_POST['tinhtrang'];
 
 		$sql_khachhang = mysqli_query($con,"INSERT INTO khachhang(Ten,SDT,Email,Diachi,tinhtrang,Pass) values ('$name','$phone','$email','$address','$giaohang','$password')");
			...
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						?>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0379190378
						</li>
						<li class="text-center border-right text-white">
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="index.php?quanly=timkiem" method="POST">
								<input class="border-15 form-control mr-sm-2" name="search_product" type="search" placeholder="Tìm kiếm sản phẩm" aria-label="Search" required>
								<button class="btn my-2 my-sm-0 border-15 " name="search_button" type="submit">Tìm kiếm</button>
							</form>
						</div>
						<!-- //search -->
						<!-- cart details -->
