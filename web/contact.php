    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" placeholder="Tên của bạn"
                                required="required" data-validation-required-message="Hãy điền tên của bạn" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="email" class="form-control" id="email" placeholder="Email"
                                required="required" data-validation-required-message="Hãy điền email của bạn" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Tới"
                                required="required" data-validation-required-message="Hãy điền người nhận" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="6" id="message" placeholder="Tin nhắn"
                                required="required"
                                data-validation-required-message="Không được để trống"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p>Đến với Nội thất Nhóm 9, bạn không chỉ nhận được những dịch vụ chất lượng mà còn nhận được những giá trị khác biệt, đó là những lời tư vấn từ sự chân thành mong muốn giúp bạn có ngôi nhà hay văn phòng đẹp, chất lượng…</p>
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>(+84) 799 158 418</p>
                </div>
