  ...
  <main class="app-content">
    ...
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item active"><a href="admin_sale.php"><b>Danh sách mã giảm giá</b></a></li>
      </ul>
      <div id="clock"></div>
    </div>
    <div class="row">
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Giá trị khuyến mãi</th>
                  <th class="text-center">Giá trị đơn hàng áp dụng</th>
              ...
              <tbody>
                  ...
                  while($rows = $results->fetch_row())
                {
                  ...
                  echo "<td class='text-center'>".date("d-m-Y",strtotime($rows[1]))."</td>";
                  if($rows[2]> 0){
                    echo "<td class='text-center'><span class='badge bg-success'>Còn lượt</span></td>";
                  } else {
